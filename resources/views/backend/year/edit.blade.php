            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="card">
                      ...
                      <div class="card-body">
                         <form method="post"id="myForm"action="{{ route('year.update',$edit->id) }}">
                            @csrf
                             <div class="row">
                            <div class="col-md-4">
                                 <label>Year Edit </label>
                                 <input type="text"name="year"class="form-control    @error ('year') is-invalid   @enderror "value="{{ $edit->year }}">
                                @error ('year')
